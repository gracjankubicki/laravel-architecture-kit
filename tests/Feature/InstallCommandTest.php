...
class InstallCommandTest extends TestCase
{
    public function test_it_generates_config_guideline_and_selected_skills(): void
    {
        ...
        $this->assertStringContainsString('| Actions | `resources/architectures/actions` | Actions are final application use cases', $guideline);
        $this->assertStringContainsString('| Laravel Best Practices | `resources/architectures/laravel-best-practices` | Prefer Laravel-native features', $guideline);
    ...
    public function test_ports_and_adapters_is_optional_and_generates_resources(): void
    {
        ...
        $this->assertStringContainsString('| Ports And Adapters | `resources/architectures/ports-and-adapters` | Ports define external boundaries', $guideline);
...
MARKDOWN);
        ...
        $this->assertStringContainsString('| Billing Workflows | `.architecture-kit/architectures/billing-workflows` | Billing workflows must keep invoice state transitions inside project-owned use cases. |', $guideline);
    ...
    public function test_it_generates_eloquent_lifecycle_resources(): void
    {
        ...
        $this->assertStringContainsString('| Eloquent Lifecycle | `resources/architectures/eloquent-lifecycle` | Observers stay thin:', $guideline);
    ...
    public function test_it_generates_enum_architecture_resources(): void
    {
        ...
        $this->assertStringContainsString('| Enums | `resources/architectures/enums` | Enums model closed sets', $guideline);
    ...
    public function test_it_generates_modern_php_85_resources_when_project_requires_php_85(): void
    {
        ...
        $this->assertStringContainsString('| Modern PHP 8.5 | `resources/architectures/modern-php-85` | Use modern PHP 8.5+ features', $guideline);
    ...
    public function test_it_generates_laravel_ai_resources_when_project_requires_laravel_ai(): void
    {
        ...
        $this->assertStringContainsString('| Laravel AI | `resources/architectures/laravel-ai` | Laravel AI agents, tools, and prompts must be typed', $guideline);
    ...
    public function test_it_generates_saloon_resources_when_required_packages_are_installed(): void
    {
        ...
        $this->assertStringContainsString('| Saloon | `resources/architectures/saloon` | Saloon owns external HTTP integrations', $guideline);
    ...
    public function test_it_generates_services_architecture_resources(): void
    {
        ...
        $this->assertStringContainsString('| Services | `resources/architectures/services` | Services aggregate several Actions', $guideline);
